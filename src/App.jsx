...
import Dotheory from "./components/student/Dotheory.jsx";
...
import EditTheory from "./components/teacher/EditTheory.jsx";
import ViewTheory from "./components/teacher/ViewTheory.jsx";
    ...
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/teacher" element={<TeacherDashboard />}>
          ...
          <Route path="edittheory/:id" element={<EditTheory />} />
          <Route path="viewtheory/:id" element={<ViewTheory />} />
        </Route>
        ...
        <Route path="/dashboard/student" element={<StudentLayout />}>
          ...
          <Route path="dotheory/:theoryid" element={<Dotheory />} />
        </Route>
