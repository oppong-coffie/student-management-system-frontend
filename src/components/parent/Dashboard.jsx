...
export default function ParentDashboard() {
  ...
  const handleNotificationClick = (notificationId) => {
    ...
    // Remove the opened notification from the list
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {/* Welcome Section */}
      <header className="flex-1 flex flex-col items-center justify-center text-center px-6 py-12 bg-white shadow-md">
      ...
      <section className="py-10 px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <DashboardCard 
          ...
          description="See extracurricular and school events participation." 
        />
        <DashboardCard 
...
function DashboardCard({ icon, title, description }) {
  return (
    <Card className="shadow-lg rounded-lg text-center border-t-4 border-[#FFD700] p-6 bg-white hover:shadow-xl transition-all">
