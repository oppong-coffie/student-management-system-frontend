...
const EditableTimetablePage = () => {
    ...
    const initialize = async () => {
      try {
        const [subjectsRes, timetableRes] = await Promise.all([
          axios.get('https://student-management-system-backend-production.up.railway.app/teachers/subjects'),
          axios.get('https://student-management-system-backend-production.up.railway.app/teachers/timetable')
        ]);
  ...
  const handleSave = async () => {
    try {
      await axios.post('https://student-management-system-backend-production.up.railway.app/teachers/timetable', { timetable });
