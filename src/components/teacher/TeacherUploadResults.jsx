...
export default function EditableResultsTable() {
    ...
    const fetchData = async () => {
      try {
        const [studentsRes, savedResultsRes] = await Promise.all([
          axios.get('https://student-management-system-backend-production.up.railway.app/teachers/students'),
          axios.get('https://student-management-system-backend-production.up.railway.app/teachers/results'),
        ]);
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch('https://student-management-system-backend-production.up.railway.app/teachers/save-results', {
        method: 'POST',
