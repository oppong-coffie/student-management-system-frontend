...
export default function TeacherNotificationPage() {
  ...
  const fetchNotifications = async () => {
    try {
      const res = await axios.get("https://student-management-system-backend-production.up.railway.app/teachers/notifications");
  ...
  const onFinish = async (values) => {
    ...
    try {
      if (editingId) {
        await axios.put(
          `https://student-management-system-backend-production.up.railway.app/teachers/notifications/${editingId}`,
          values
        );
        message.success("Notification updated!");
      } else {
        await axios.post("https://student-management-system-backend-production.up.railway.app/teachers/notifications", values);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://student-management-system-backend-production.up.railway.app/api/notifications/${id}`);
